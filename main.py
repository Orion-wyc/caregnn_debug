...
from utils import EarlyStopping, calc_mean_sd
...
def main(args):
    ...
    # Load dataset
    dataset = FraudDataset(args.dataset, train_size=0.4, force_reload=True, random_seed=args.seed)
    graph = dataset[0]
    ...
    return [best_val_recall, best_val_auc, test_recall, test_auc]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_runs', type=int, default=1, help='Repeat the training N times')
